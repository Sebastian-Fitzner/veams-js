	...
	function(ImageLoader, $, Backbone, Pagination, TouchSwipe, App) {
		...
		App.ui.Carousel = Backbone.View.extend({
			...
			options: {
				...
				carouselPager: '[data-js-atom="carousel-pagination"]'
			},
			...
			setNewSlide: function() { // Just setting the current slide
			 ...
			 */
			animateToNewSlide: function(slides, direction) { // Here the magic animation is happen
